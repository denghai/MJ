...
// single recorder 
class CYMJSingleRoundRecorder
	:public ISingleRoundRecorder
{
public:
	std::shared_ptr<IPlayerReocrderInfo> createPlayerRecorderInfo()override
	{
		return std::make_shared<CYMJPlayerRecorderInfo>();
	}
};

// room recorder 
class CYMJRoomRecorder
...
public:
	...
	{
		return std::make_shared<CYMJSingleRoundRecorder>();
	}
