...
// single recorder 
class JSMJSingleRoundRecorder
	:public ISingleRoundRecorder
{
public:
	std::shared_ptr<IPlayerReocrderInfo> createPlayerRecorderInfo()override
	{
		return std::make_shared<JSMJPlayerRecorderInfo>();
	}
};

// room recorder 
class JSMJRoomRecorder
...
public:
	...
	{
		return std::make_shared<JSMJSingleRoundRecorder>();
	}
