...
// single recorder 
class HHMJSingleRoundRecorder
	:public ISingleRoundRecorder
{
public:
	std::shared_ptr<IPlayerReocrderInfo> createPlayerRecorderInfo()override
	{
		return std::make_shared<HHMJPlayerRecorderInfo>();
	}
};

// room recorder 
class HHMJRoomRecorder
...
public:
	...
	{
		return std::make_shared<HHMJSingleRoundRecorder>();
	}
